    ...
    <>
        ...
        <section className="hero">
          ...
          <div className="hero-text" id="heroText">
            ...
            <div className="cta-row">
              ...
              <Link href="/alacritas" className="btn btn-ghost">Try Alacritas</Link>
            </div>
          </div>
          <HeroGear />
        </section>
      ...
      <div className="tape" aria-hidden="true">
        <div className="tape-in">
          <span>NUEVA ARCADE <b>&#9670;</b> BUILT BY 10S4 <b>&#9670;</b> INSERT COIN <b>&#9670;</b> WORKSHOP &middot; ARCADE &middot; CAF&Eacute; &middot; ALACRITAS <b>&#9670;</b> PRESS START <b>&#9670;</b>&nbsp;</span>
          <span>NUEVA ARCADE <b>&#9670;</b> BUILT BY 10S4 <b>&#9670;</b> INSERT COIN <b>&#9670;</b> WORKSHOP &middot; ARCADE &middot; CAF&Eacute; &middot; ALACRITAS <b>&#9670;</b> PRESS START <b>&#9670;</b>&nbsp;</span>
        </div>
      </div>
      ...
      <div className="wrap">
        <section id="about">
          ...
          <p className="reveal" style={{ maxWidth: "62ch", marginTop: "22px" }}>
            ...
            AI, our own games, our own engineering, and now our own food-tech. The arcade is what our R&amp;D into games became;
        ...
        <section>
          ...
          <div className="pillars reveal">
            <div className="pillar" data-n="A">
              ...
              <p>Our innovation arm &mdash; the AI, the games, the engineering, and Alacritas. Where our curiosity turns into things that work.</p>
            </div>
            ...
            <div className="pillar" data-n="C">
              ...
              <p>The gathering bench. Food, iced coffee, conversation, and Alacritas turning the caf&eacute; into a small food-tech demo.</p>
            </div>
          </div>
        </section>
      </div>
      ...
      {/* ALACRITAS */}
      <div className="wrap">
        <section id="alacritas">
          <div className="sec-head reveal" data-num="05">
            <span className="sec-num">05 / Caf&eacute; AI</span>
            <h2>Meet Alacritas.</h2>
            <p>
              Alacritas is our caf&eacute;-side calorie estimate AI. Upload a food photo, add a note like
              <code>iced coffee with milk and sugar</code>, and it returns a simple nutrition receipt with
              estimated calories, protein, carbs, and fat. It is an estimate for awareness, not medical advice.
            </p>
          </div>

          <div className="alacritas-home-card reveal">
            <div>
              <span className="vf-k">Nueva AI Lab</span>
              <h3>Food tech beside the arcade.</h3>
              <p>
                The arcade draws people in; the caf&eacute; keeps them there. Alacritas connects the food division back
                to our workshop idea by making the café part interactive too.
              </p>
            </div>
            <Link href="/alacritas" className="btn btn-primary">Open Alacritas</Link>
          </div>
        </section>
      </div>
      ...
      <div className="wrap">
        <section id="team">
          <div className="sec-head reveal" data-num="06">
            <span className="sec-num">06 / The Team</span>
